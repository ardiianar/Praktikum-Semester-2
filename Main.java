...
public class Main {
    public static void main(String[] args) {
        ...
        Manusia lakiMenikah = new Manusia("Iksan", "3224050305020004", true, true);
        System.out.println(lakiMenikah);

        System.out.println("\nb. Perempuan telah menikah:");
        Manusia perempuanMenikah = new Manusia("Danu", "3113455307030001", false, true);
        System.out.println(perempuanMenikah);

        System.out.println("\nc. Belum menikah:");
        Manusia belumMenikah = new Manusia("Bambang", "2135533910010003", false, false);
